function inlineBlockWord(word: string) {
  return (
    <span className="inline-block sm:block mr-2">
      <span className="inline rounded bg-stone-950 text-stone-100 px-2">
        {word}
      </span>
    </span>
  );
...
function bigwheel() {
  return (
    <div className="relative -mt-[420px] -ml-14 sm:ml-0 sm:mt-0">
      <div
        className="
  ...
  return (
    <header>
      ...
      <p className="my-3 z-10 bg-white">
        ...
        This is a list of active teams and clubs that host rides throughout the
        season.
      ...
      <div className="z-10 bg-stone-100 rounded p-3 text-base mb-10">
        <div className="flex">
          ...
          <div>
            <p className="mb-2">
              Updated for Spring 2024. Schedules change, so it’s best to use the
              Facebook event page, Instagram, calendar, or other links below to
              confirm the exact details of the ride.
            </p>
