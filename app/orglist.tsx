...
export default function OrgList(): OrgParams[] {
	return [
		...
		},
		{
			...
			tags: [OrgTags.SOCIAL],
			description: <p>Rides lead by Behind Bars Bicycle Shop ambassadors leave from the shop and are announced on instagram.</p>,
		...
		},
		{
			...
			description: <p>All kinds of events, from rides to workshops and even violence prevention training with collaborators. <a href="https://www.instagram.com/p/DJHYNPsRQtW">Serene Spins on Sundays for women & children only</a>.</p>,
		...
		},
		{
			...
			description: <p>Keep an eye out for the <a href="https://www.instagram.com/corpsewhaleracing/p/C-vpFFUs5jp/">Taco Bell Century</a> in the fall.</p>,
		...
		},
		{
			...
			description: <p>Rides on the first Tuesday of the month throughout the summer <a href='https://www.instagram.com/p/DJEtdhkOkvc/?utm_source=ig_web_copy_link'>were announced</a>.</p>,
		...
		},
		{
			...
			description: <p>The team leads themed Thursday social rides that start at Behind Bars and typically end at Bauhaus Brewery. <a href="https://www.facebook.com/handupracing/events">2025 ride calendar is out</a></p>,
		...
		},
		{
			...
			description: <p><a href="https://www.instagram.com/p/DH9Xv7vpE4D">Monthly Monday rides for 2025</a> are happening once again.</p>,
		...
		},
		{
			...
			description: <span>Meets year-round for family-friendly social rides at a casual (7–9mph) pace. Also hosts <a href="https://www.instagram.com/p/DHONlrPsWUB/">DJ dance rides for 2025 in collaboration with Perennial Cycle</a>. All events promoted on Facebook and Instagram.</span>,
		...
		},
		{
			...
			description: <p>See their website for <a href="https://www.dirtlegion.com/group-ride-information">group rides</a>, skills clinics, and more.</p>,
		...
		},
		{
			...
			description: <>
				...
				<Quote>
					<span>Coffee (Outside) is our weekly excuse to start off the week on a bike. Everyone is always welcome. We will bring some treats to share. You bring you (and maybe a friend).</span>
				</Quote>
			</>,
			tags: [OrgTags.SOCIAL],
		...
		},
		{
			...
			description: <p>In partnership with Recovery Bike Shop. Wednesday rides for the season <a href="https://www.instagram.com/p/DHqlJ-CMc9b/">announced on instagram</a></p>,
			tags: [OrgTags.SOCIAL],
		...
		},
		{
			...
			description: <span>Stamina Racing has previously partnered with <a href="https://driftlessgravelcamp.com/">driftless gravel camp</a> in the spring to encourage and equip FTWNB riders to pursue gravel adventures.</span>,
			image: "/images/Stamina_Racing_Collective_Group.jpg",
			instagram: "https://www.instagram.com/stamina.racing.collective/"
		},
		{
			name: "Stöke MTB",
			quote: "Stöke MTB empowers you to discover the joy of mountain biking in a fun, safe, and inclusive environment. Learn fundamental skills and level up your riding under the guidance of certified and insured instructors.",
